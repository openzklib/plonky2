...
impl<F: Field + Extendable<D>, const D: usize> Gate<F, D> for PublicInputGate {
    fn id(&self) -> String {
...
impl<F: Field + Extendable<D>, const D: usize> PackedEvaluableBase<F, D> for PublicInputGate {
