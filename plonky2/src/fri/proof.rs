...
#[serde(bound = "")]
pub struct FriQueryStep<F: Field + Extendable<D>, H: Hasher<F>, const D: usize> {
...
#[derive(Serialize, Deserialize, Clone, Debug, Eq, PartialEq)]
#[serde(bound = "")]
pub struct FriInitialTreeProof<F: Field, H: Hasher<F>> {
    pub evals_proofs: Vec<(Vec<F>, MerkleProof<F, H>)>,
}

impl<F: Field, H: Hasher<F>> FriInitialTreeProof<F, H> {
...
#[derive(Serialize, Deserialize, Clone, Debug, Eq, PartialEq)]
#[serde(bound = "")]
pub struct FriQueryRound<F: Field + Extendable<D>, H: Hasher<F>, const D: usize> {
...
#[derive(Serialize, Deserialize, Clone, Debug, Eq, PartialEq)]
#[serde(bound = "")]
pub struct CompressedFriQueryRounds<F: Field + Extendable<D>, H: Hasher<F>, const D: usize> {
    /// Query indices.
...
#[derive(Serialize, Deserialize, Clone, Debug, Eq, PartialEq)]
#[serde(bound = "")]
pub struct FriProof<F: Field + Extendable<D>, H: Hasher<F>, const D: usize> {
...
#[derive(Serialize, Deserialize, Clone, Debug, Eq, PartialEq)]
#[serde(bound = "")]
pub struct CompressedFriProof<F: Field + Extendable<D>, H: Hasher<F>, const D: usize> {
    /// A Merkle cap for each reduced polynomial in the commit phase.
    pub commit_phase_merkle_caps: Vec<MerkleCap<F, H>>,
...
impl<F: Field + Extendable<D>, H: Hasher<F>, const D: usize> FriProof<F, H, D> {
...
impl<F: Field + Extendable<D>, H: Hasher<F>, const D: usize> CompressedFriProof<F, H, D> {
...
pub struct FriChallenges<F: Field + Extendable<D>, const D: usize> {
