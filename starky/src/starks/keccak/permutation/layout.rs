//! Keccak Permutation Layout

use super::{NUM_INPUTS, NUM_ROUNDS};
...
pub struct Row<T> {
    ///
    pub round: [T; NUM_ROUNDS],

    ///
    pub input_limbs: [T; 0],

    ///
    pub output_limbs: [T; 0],
    ...
    ///
    pub a_prime_prime: [T; 0],

    ///
    pub a_prime_prime_prime_0_0_bits: [T; 0],

    ///
    pub input_filter: [T; 0],

    ///
    pub output_filter: [T; 0],
}
...
pub const REG_INPUT_FILTER: usize = REG_A_PRIME_PRIME_PRIME_0_0_HI + 1;
pub const REG_OUTPUT_FILTER: usize = REG_INPUT_FILTER + 1;

pub(crate) const NUM_COLUMNS: usize = REG_OUTPUT_FILTER + 1;
